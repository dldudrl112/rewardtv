...
<div class="container body">
    <div class="main_container">
        <div class="col-md-3 left_col">
            <div class="left_col scroll-view" style="background: #87b35c;">
                <div class="navbar nav_title" style="border: 0; background: #87b35c;">
                    <a href="/admin/slideList" class="site_title"><img src="/assets/images/symbol.png" alt=""> <span>RewardTv</span></a>
                </div>
                        ...
                        <ul class="nav side-menu">
                            <li><a><i class="fa fa-edit"></i> Main <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="/admin/slideList">메인 슬라이드 관리</a></li>
                                    <!-- <li><a href="/admin/yutubeList">메인 유튜브영상 관리</a></li> -->
                                </ul>
                            ...
                            <!-- <li><a><i class="fa fa-edit"></i> 소식 <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="/admin/newsList">소식 괸리 </a></li>
                                </ul>
                            </li> -->
                        </ul>
                    </div>
