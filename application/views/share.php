        ...
        function sendLink() {
          Kakao.Link.sendDefault({
            ...
            content: {
              title: '뉴턴트리',
              description: '웹 사이트',
              // imageUrl: 'http://rewardtv.cafe24.com/assets/uploads/a47d94e2ee3fdbe6261c00b51b29681d',
              link: {
                // mobileWebUrl: 'http://rewardtv.cafe24.com/admin',
                // webUrl: 'http://rewardtv.cafe24.com/admin'
              }
            }
          });
        }
