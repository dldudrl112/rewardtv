     ...
     function admin() {
         this.slide = function() {
             ...
             $('body').on('change', '#slideimage', function() {
                 ...
                 $(this).next().next().attr('src','https://rewardtv.co.kr/assets/uploads/'+json.url[0]);
             });
         }
         ...
         this.yutube = function() {
             $('body').on('click', '#yutubego, #yutubeedit', function() {
                 ...
                 if(check) {
                     ...
                     if($(this).attr('id') == "yutubego"){
                         var json = jsonreturn('/admin/yutubeinsertData',data);
                         if(json.return == true) {
                             alert("등록되었습니다");
                             location.href = "/admin/yutubeList";
                         }
                     }
                     else {
                         var json = jsonreturn('/admin/yutubeUpdate',data);
                         if(json.return == true) {
                             alert("수정되었습니다");
                             location.reload();
                         }
             ...
             $('body').on('change', '#yutubeimage', function() {
                 ...
                 $(this).next().val(json.url[0]);
                 $(this).next().next().css('display','block');
                //  $(this).next().next().attr('src','http://rewardtv.co.kr/assets/uploads/'+json.url[0]);
             });
         }
           ...
           $('body').on('click', '#newsgo, #newsedit', function() {
               ...
               if(check) {
                   ...
                   if($(this).attr('id') == "newsgo"){
                       var json = jsonreturn('/admin/newsInsertData',data);
                       if(json.return == true) {
                           alert("등록되었습니다");
                       ...
                       var json = jsonreturn('/admin/newsUpdate',data);
                       if(json.return == true) {
                           alert("수정되었습니다");
                           location.reload();
                       }
     ...
     $('body').on('change', '#logo, #logos, #slide', function() {
        ...
        if (json) {
          ...
          if(json.url[1]) {
            ...
            //   $('.youtubb').after('<img src="http://rewardtv.co.kr/assets/uploads/'+json.url[i]+'" class = "slidess">');
              $(this).next().next().css('display','block');
            }
          }
          else {
